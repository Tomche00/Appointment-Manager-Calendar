...
- Name: e2e/patient-management.spec.ts >> Patient Management — Standalone Creation >> cannot create patient with duplicate email
- Location: tests/e2e/patient-management.spec.ts:53:3
...
Locator: getByTestId('error-email-duplicate')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('error-email-duplicate')
    ...
    - list [ref=e4]:
      - listitem [ref=e5]:
        - generic [ref=e6]:
          ...
          - generic [ref=e8]: Duplicate User е додаден во системот
              ...
              - row "CO Carol Osei Роден јул 4, 1990 carol.osei@test.medical 555-0199 No visits yet 0 термини First visit" [ref=e192] [cursor=pointer]:
                ...
                - cell "First visit" [ref=e213]:
                  - generic [ref=e214]:
                    ...
                    - img [ref=e216]
              - row "DU Duplicate User Роден јан 1, 2000 alice.thornton@test.medical 555-9999 No visits yet 0 термини No notes added" [ref=e219] [cursor=pointer]:
                - cell "DU Duplicate User Роден јан 1, 2000" [ref=e220]:
                  - generic [ref=e221]:
                    - generic [ref=e222]: DU
                    - generic [ref=e223]:
                      - generic [ref=e224]: Duplicate User
                      - generic [ref=e225]: Роден јан 1, 2000
                - cell "alice.thornton@test.medical 555-9999" [ref=e226]:
                  - generic [ref=e227]:
                    - generic [ref=e228]:
                      - img [ref=e229]
                      - generic [ref=e232]: alice.thornton@test.medical
                    - generic [ref=e233]:
                      - img [ref=e234]
                      - generic [ref=e236]: 555-9999
                - cell "No visits yet" [ref=e237]
                - cell "0 термини" [ref=e238]:
                  - generic [ref=e239]: 0 термини
                - cell "No notes added" [ref=e240]:
                  - generic [ref=e241]:
                    - paragraph [ref=e242]: No notes added
                    - img [ref=e243]
```
