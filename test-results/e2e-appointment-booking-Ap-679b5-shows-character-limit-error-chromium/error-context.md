...
- Name: e2e/appointment-booking.spec.ts >> Appointment Booking — Validation >> submit with invalid notes length shows character-limit error
- Location: tests/e2e/appointment-booking.spec.ts:80:3
