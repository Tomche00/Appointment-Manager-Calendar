...
- Name: e2e/drag-drop-rescheduling.spec.ts >> Drag & Drop Rescheduling >> drag cancelled mid-gesture (Escape key) reverts to original position
- Location: tests/e2e/drag-drop-rescheduling.spec.ts:170:3
